...
const Clips = ({ clip, imgsrc }) => {
  return (
   <>
      <div className='relative h-[112px] w-[128px] rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-[80px]  md:w-24 sm:w-16 lg:h-[80px] md:h-20 sm:h-14'>
        <img
            src={imgsrc}
            alt="img/clips"
            className='inset-0 flex h-[112px] w-[128px] object-cover absolute top-0 left-0 right-0 rounded-xl opacity-100 z-10 transition-opacity duration-500'
        />
